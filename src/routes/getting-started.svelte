...
<div class="getting-started">
	...
	<h2>Watch it sync</h2>
	<p>
		<a target="_blank" href="http://localhost:5173">Open the app in a new tab</a>. You should see the todos you added in
		the other window.
	</p>
	<h2>Go offline</h2>
	...
	<h2>Read more</h2>
	<p>
		Read our <a href="https://triplit.dev/docs">docs</a> to learn more about everything you can do with Triplit.
	</p>
</div>
